...
while (messagesExist) {
    ...
    // Open dropdown 
    getElementByXpath("/html/body/div[5]/div[3]/div[2]/div/div/main/div/section[2]/div[1]/div[1]/div/div[1]/button").click();

    // Select delete dropdown item
    getElementByXpath("/html/body/div[5]/div[3]/div[2]/div/div/main/div/section[2]/div[1]/div[1]/div/div[1]/div/div/div/ul/div[2]").click();
